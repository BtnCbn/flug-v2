...
*/}}
{{- define "flug.labels" -}}
helm.sh/chart: {{ include "flug.chart" . }}
{{ include "flug.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "flug.selectorLabels" -}}
app: {{ include "flug.name" . }}
app.kubernetes.io/name: {{ include "flug.name" . }}
